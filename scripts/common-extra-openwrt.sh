...
svn co https://github.com/spin200/HC5962-OpenWrt/tree/master/server/default-settings package/danxiaonuo/default-settings
# 增加IPV6
curl -fsSL https://raw.githubusercontent.com/spin200/HC5962-OpenWrt/master/server/etc/99-ipv6 > package/base-files/files/etc/hotplug.d/99-ipv6
...
# 修改系统欢迎词
curl -fsSL https://raw.githubusercontent.com/spin200/HC5962-OpenWrt/master/server/etc/bannera > package/base-files/files/etc/banner
# 修改系统内核参数
